...
ECMP uses schema-driven content definitions and stores flexible content instance data, content type schemas, file metadata, folder metadata, and published delivery projections.
