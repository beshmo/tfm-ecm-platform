...
- **THEN** the system returns type definitions including `cmis:folder`, `cmis:document`, and supported ECMP custom types
...
- **THEN** the system maps the schema to a stable CMIS custom type identifier and exposes supported field definitions as CMIS properties
